        ...
        <h2 className='container'>Habilidades técnicas</h2>
                    ...
                    <div className='col-lg-6 textCard1'>
                        <div className='col-lg-8 habilidades'>
                            <h3>Lenguajes de Programación y Frameworks:</h3>
                                <p>Desarrollo de lógica robusta y escalable en backend, y creación de aplicaciones web dinámicas e independientes en el lado del cliente, garantizando siempre un código limpio y eficiente.</p>
                                <ul>
                ...
                <div className="row card1">
                    <div className='col-lg-6 textCard1'>
                        <div className='col-lg-8 habilidades'>
                            ...
                            <p>Maquetación ágil y orientada al rendimiento (WPO). Huyo de constructores pesados programando vistas desde cero, asegurando interfaces 'Pixel Perfect' que se adaptan a cualquier dispositivo.</p>
                                <ul>
                ...
                <div className="row card1">
                    <div className='col-lg-6 textCard1'>
                        <div className='col-lg-8 habilidades'>
                            ...
                            <p>Construyo arquitecturas de datos avanzadas mediante ACF y CPT UI integradas en Custom Themes exclusivos, combinando un diseño visual impecable con Elementor Pro y un rendimiento técnico superior.</p>
                                <ul>
                                    <li><strong>WordPress: Custom Themes, ACF, CPT UI, Elementor Pro</strong></li>
            ...
            <div className="container">
                <div className="row card1">
                    <div className='col-lg-6 textCard1'>
                        <div className='col-lg-8 habilidades'>
                        <h3>Servidores, Bases de Datos y Despliegue</h3>
                        <p>Gestión integral del entorno de alojamiento y almacenamiento. Experiencia en migraciones completas de proyectos, transferencias de dominios y configuración de entornos seguros para garantizar el máximo rendimiento y estabilidad.</p>
                                <ul>
                                    <li><strong>Bases de Datos: MySQL (Diseño, administración y exportación/importación).</strong></li>
                                    <li><strong>Hosting y Servidores: Migraciones integrales de proyectos entre proveedores (por ejemplo, de IONOS a SiteGround) y optimización de recursos.</strong></li>
                                    <li><strong>Dominios y Seguridad: Transferencias, gestión de zonas DNS y configuración de certificados SSL.</strong></li>
                                </ul>
                        </div>
                    </div>
                    <div className='col-lg-6 p-0'>
                ...
                <div className="row card1">
                    <div className='col-lg-6 textCard1'>
                        <div className='col-lg-8 habilidades'>
                            ...
                            <p>PProgramación orientada al posicionamiento orgánico. Optimización del código para cumplir con los estándares de Google y despliegue de herramientas de medición para el análisis de tráfico.</p>
                                <ul>
                                    <li><strong>SEO Técnico: WPO, optimización de imágenes y jerarquía de encabezados.</strong></li>
                                    <li><strong>Analítica web: Google Analytics (GA4).</strong> </li>
                                    <li><strong>Supervisión Web: Google Search Console y Lighthouse.</strong> </li>
                                </ul>
                        </div>
                    </div>
                    <div className='col-lg-6 p-0'>
                ...
                <div className="row card1">
                    <div className='col-lg-6 textCard1'>
                        <div className='col-lg-8 habilidades'>
                            ...
                            <p>Traducción fiel de diseños UI/UX a código funcional, manteniendo un flujo de trabajo profesional, organizado y colaborativo mediante el control de versiones.</p>
                                <ul>
